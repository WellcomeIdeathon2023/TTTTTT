...
ui <- navbarPage(
  ...
  tabPanel("Overview", 
    ...
    column(
     ...
     a("The Substance Abuse and Mental Health Services Adminstration (SAMHSA) data store", href="https://www.samhsa.gov/data/data-we-collect/mh-cld-mental-health-client-level-data"),
     p("The Copernicus climate data store contains observations of atmospheric methane (CH4) amounts collected by current and historic satellite instruments."),
     p("The CDC WONDER brings together public health data-sets. Specifically, we make use of the underlying cause of death database, which contains mortality and population counts across counties in the United States of America."),
     p("The SAMHSA data store contains data from people receiving mental health treatment services provided or funded through state mental health agencies in the United States of America"),
